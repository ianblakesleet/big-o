...
// ANSWER: No, a traditional for loop has a time of O(n), setting the i, less than or euqal to 4 makes it O(1)
...
// ANSWER: space complexity can only be linear, but we can improve the writing of it.
const gt = (n) => {
  let answer = []
...
// ANSWER: both are determined by the size of the str
